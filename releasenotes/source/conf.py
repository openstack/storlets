...
# storlets documentation build configuration file, created by
...
import datetime
# TODO(kota_): rework with package versioning in docs
# from storlets import __version__
...
htmlhelp_basename = 'StorletsReleaseNotesdoc'
